...
GT_I3_pro_B marlin firmware.zip potentially contains the marlin source code to produce the above blobs. The source was found at this link:

http://forums.reprap.org/read.php?1,703169
